    ...
    if recognition_result_list:
      ...
      for hand_index, hand_landmarks in enumerate(
        ...
        if recognition_result_list[0].gestures:
          ...
          # if not str(category_name) == "None":
          prev3[2] = prev3[1];
          prev3[1] = prev3[0];
          prev3[0] = str(category_name)
          print(f'hand {hand_index} {result_text} curr fps: {FPS}')
          if str(category_name) == "Pointing_Up":
            GPIO.output(17, True) # most significant
            GPIO.output(27, True)
            GPIO.output(22, True) # least significant
            
          if str(category_name) == "ILoveYou":
            GPIO.output(17, True) # most significant
            GPIO.output(27, True)
            GPIO.output(22, False) # least significant
            
          if str(category_name) == "Victory":
            GPIO.output(17, True) # most significant
            GPIO.output(27, False)
            GPIO.output(22, True) # least significant
            
          if str(category_name) == "Thumb_Down":
            GPIO.output(17, True) # most significant
            GPIO.output(27, False)
            GPIO.output(22, False) # least significant
          
          if str(category_name) == "Thumb_Up":
            GPIO.output(17, False) # most significant
            GPIO.output(27, True)
            GPIO.output(22, True) # least significant
              
          if str(category_name) == "Open_Palm":
            GPIO.output(17, False)
            GPIO.output(27, True)
            GPIO.output(22, False)

          if str(category_name) == "Closed_Fist":
            GPIO.output(17, False)
            GPIO.output(27, False)
            GPIO.output(22, True)
